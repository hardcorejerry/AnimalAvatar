...
COP3D_DATA_ROOT_PATH = './custom_data/custom_data'
CUSTOM_DATA_ROOT_PATH = './custom_data/custom_data'
...
class Keys:
    def __init__(self):
        ...
        self.source_init_shape = os.path.join(self.external_data_path, "init_pose")

        # COP3D Dataset root
        self.dataset_root = COP3D_DATA_ROOT_PATH
        self.custom_dataset_root = CUSTOM_DATA_ROOT_PATH
        ...
        # List of CoP3D sequences used for evaluation
        self.subsetcop3d_eval50 = [
            "1030_23106_17099",
            "1050_43243_38827",
            "1022_15133_10069",
            "1009_3157_2796",
